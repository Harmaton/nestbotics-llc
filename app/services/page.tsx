...
const services = [
  {
    title: "Weld Development",
    description: "We specialize in developing high-quality, repeatable weld processes for robotic applications. From initial setup to final optimization, we ensure every weld meets both structural and visual standards while maintaining efficiency on the production floor.",
    icon: (
  ...
  },
  {
    ...
    description: "We provide advanced robot programming support for industrial welding systems, with a focus on reliability, flexibility, and ease of operation for your team.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: "We help manufacturers maximize throughput by identifying inefficiencies and optimizing every aspect of the robotic welding process.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: "Operator & Programming Training",
    description: "We provide hands-on training for operators, technicians, and engineers to ensure your team can confidently run, maintain, and optimize your robotic systems.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
